...
\textbf{Live App:} \url{https://newsvendor-simulation.streamlit.app}
...
The engine is wrapped in a Streamlit app (\texttt{app.py}), live at the
\href{https://newsvendor-simulation.streamlit.app}{project's app URL} (see title block), meeting
the brief's ``pretty and interesting to use'' requirement with a real, runnable tool. All economic
inputs (price, cost,
